...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    <footer 
      className={`flex w-full flex-col items-stretch text-[15px] text-[rgba(2,77,54,1)] font-normal whitespace-nowrap justify-center py-px border-[rgba(151,151,151,1)] border-t ${className}`}
    >
